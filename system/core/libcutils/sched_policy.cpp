...
// fosmod_perf_cgroup begin
#include <fireos/FosMods.h> // fosmod_fosmods
#ifdef FOSMOD_PERF_CGROUP_DEF
#include <fireos/vendor-callback/AmazonLibcutilsCallbacks.h>
#endif
// fosmod_perf_cgroup end
//
...
static void __initialize() {
    ...
    // fosmod_perf_cgroup begin
#ifdef FOSMOD_PERF_CGROUP_DEF
    android::schedPolicy_fosExt_schedgroupInit();
#endif
    // fosmod_perf_cgroup end
...
int set_cpuset_policy(int tid, SchedPolicy policy)
{
    ...
    // fosmod_perf_cgroup begin
#ifdef FOSMOD_PERF_CGROUP_DEF
    android::schedPolicy_fosExt_setCgroupPolicy(tid, policy);
#endif
    // fosmod_perf_cgroup end
