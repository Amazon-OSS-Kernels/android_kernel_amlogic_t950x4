...
/* 2021/12/29 --- V2.32 --- Fix unable to find symbol aml_atvdemod_attach. */
/* 2022/06/16 --- V2.33 --- Fix audio setting and resume. */
/* 2022/08/27 --- V2.34 --- Fix ripples. */
/* 2023/07/04 --- V2.35 --- add afc enable and state IO control. */
