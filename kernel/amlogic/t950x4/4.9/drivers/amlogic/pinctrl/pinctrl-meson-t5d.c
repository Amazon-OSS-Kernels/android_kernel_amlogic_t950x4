/*
 * drivers/amlogic/pinctrl/pinctrl-meson-t5d.c
 *
...
static struct meson_bank meson_t5d_periphs_banks[] = {
	...
	BANK("B",    GPIOB_0,    GPIOB_13, 33,
	     0,  0,  0,  0,  0,  0,  1, 0,  2, 0),
	BANK("W",    GPIOW_0,    GPIOW_12, 67,
	     3,  0,  3,  0,  9,  0,  10,  0,  11,  0),
	BANK("Z",    GPIOZ_0,    GPIOZ_19,  47,
	     1,  0,  1,  0,  3,  0,  4, 0,  5, 0),
	BANK("H",    GPIOH_0,    GPIOH_21,  11,
	     2,  0,  2,  0,  6,  0,  7, 0,  8, 0),
	BANK("M",    GPIOM_0,    GPIOM_29,  83,
...
static struct meson_bank meson_t5d_analog_banks[] = {
	/* name  first  last  irq  pullen  pull  dir  out  in  */
	BANK("ANALOG",  CDAC_IOUT,  CVBS1,  113,
...
static struct meson_drive_bank meson_t5d_periphs_drive_banks[] = {
	/*	 name	 first		lask	   reg	offset  */
	BANK_DRIVE("B",  GPIOB_0, GPIOB_13, 0x0, 0),
	BANK_DRIVE("W",  GPIOW_0, GPIOW_12, 0x5, 0),
	BANK_DRIVE("Z",  GPIOZ_0, GPIOZ_19, 0x1, 0),
	BANK_DRIVE("H",  GPIOH_0, GPIOH_21, 0x3, 0),
	BANK_DRIVE("M",  GPIOM_0, GPIOM_29, 0x6, 0)
};

static struct meson_drive_data meson_t5d_periphs_drive_data = {
	.drive_banks	= meson_t5d_periphs_drive_banks,
	.num_drive_banks = ARRAY_SIZE(meson_t5d_periphs_drive_banks),
};
...
static struct meson_drive_bank meson_t5d_aobus_drive_banks[] = {
	BANK_DRIVE("D", GPIOD_0, GPIOD_10, 0x0, 0),
	BANK_DRIVE("E", GPIOE_0, GPIOE_2, 0x1, 0)
};

static struct meson_drive_data meson_t5d_aobus_drive_data = {
	.drive_banks     = meson_t5d_aobus_drive_banks,
	.num_drive_banks = ARRAY_SIZE(meson_t5d_aobus_drive_banks),
};
...
static struct meson_pinctrl_data meson_t5d_periphs_pinctrl_data = {
	...
	.pcf_drv_data	= &meson_t5d_periphs_drive_data,
};
...
static struct meson_pinctrl_data meson_t5d_aobus_pinctrl_data = {
	...
	.pcf_ops	= &meson_g12a_pinconf_ops,
	.pcf_drv_data	= &meson_t5d_aobus_drive_data,
};
...
static void __exit t5d_pmx_exit(void)
{
	platform_driver_unregister(&meson_t5d_pinctrl_driver);
}

arch_initcall(t5d_pmx_init);
module_exit(t5d_pmx_exit);
MODULE_DESCRIPTION("t5d pin control driver");
