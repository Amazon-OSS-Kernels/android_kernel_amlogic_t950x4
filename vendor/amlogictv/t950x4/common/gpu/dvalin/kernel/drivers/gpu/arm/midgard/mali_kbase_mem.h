 ...
 */
#define KBASE_MEM_POOL_MAX_SIZE_KBDEV (SZ_4M >> PAGE_SHIFT)
...
#define DEFAULT_MAX_SIZE_KCTX  (SZ_64M >> PAGE_SHIFT)

/*
 * Threshold for choosing GPU mem alloc from (in pages)
 */
#define KBASE_MEM_THRESHOLD  (DEFAULT_MAX_SIZE_KCTX * 3)
