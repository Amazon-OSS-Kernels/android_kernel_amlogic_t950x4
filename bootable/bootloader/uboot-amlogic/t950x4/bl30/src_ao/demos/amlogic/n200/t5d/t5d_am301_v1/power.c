...
static IRPowerKey_t prvPowerKeyList[] = {
	...
	{ 0x3e97, IR_NORMAL}, /* TCL--- setting key */
	{ 0x36ab, IR_NORMAL}, /* TCL--- ok key */
	{ 0x3ea9, IR_NORMAL}, /* TCL--- home key */
	{ 0x3685, IR_CUSTOM_2}, /* TCL--- prime  key */
	{ 0x3eb9, IR_CUSTOM_1}, /* TCL--- netflix key */
	{ 0x3695, IR_NORMAL}, /* TCL--- music key */
	{ 0x36a5, IR_NORMAL}, /* TCL--- app key */
	{ 0x3ebf, IR_NORMAL}, /* TCL--- alexa key */
#endif
	{}
        /* add more */
};
