...
void vLedControl()
{
...
#endif
	{
		...
		} else if (5 == board_id && reason == 0) { /* Maribronze led cannot be control */
			printf("maribronze cold_boot don't control led\n");
		} else {
...
#ifdef BL30_LOG_SHARE_TO_KERNEL
	rb = init_ring_buffer((unsigned char *)BL30MSG_BUF_BASE,BL30MSG_BUF_SIZE);
#endif
	version();
